...
describe('FilterService', () => {
    ...
    describe('contains()', () => {
        ...
        // Teste novo
        it('deve retornar true se a string de valor é igual ao filtro', () => {
            expect(contains('Leandro Lo', 'Leandro Lo')).toBe(true);
        });

        // Teste novo
        it('deve retornar false se a string de valor é uma substring da string de filtro', () => {
            expect(contains('Leandro Lo', '[RIP] Leandro Lo'));
        });
    });
